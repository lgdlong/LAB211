...
import comparator.ByCusName;
import repository.itf.ICustomerRepository;
import repository.itf.IFeastRepository;
import repository.itf.IOrderRepository;
import utils.InputData;
import comparator.ByOrderPrice;
...
public class Service {
    ...
    public void displayCustomerList() {
        ...
        cusRepo.getCusList().sort(new ByCusName());
    ...
    public void displayOrderList() {
        ...
        displayOrderHeader();
        orderRepo.getOrderList().sort(new ByOrderPrice());
